    ...
    <div className="about-container">
      <div className="about-card">
        ...
        <h3>
          ...
          commentated basketball games. When I&apos;m not working, I enjoy
          skiing, skating, playing soccer, exercising, and playing Minecraft. I
          also love the outdoors, so you might find me hiking, caoeing, and
          camping in the Upper Valley. <br />
          ...
          double major. <br />
          <br />
          On campus, I am a full stack developer for Dartmouth&apos;s Digital
          Applied Learning and Innovation (DALI) Lab where I work in a scrum
          team to design prototype projects in 10 week sprints. I am also an
          executive in Dartmouth&apos;s Delta Beta chapter of Sigma Nu, and
          I&apos;m involved in the Dartmouth Outing Club. Recently, I
          volunteered to be a Trip Leader for Dartmouth&apos;s First Year Trips
          program where I had the privilige of giving new students an extensive
